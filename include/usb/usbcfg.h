 ...
 * USB Configuration
 */
#define USB_POWER           1			/* 0 - bus, 1 - self */
#define USB_IF_NUM          4			/* max number of interfaces */
#define USB_EP_NUM          32			/* max number of endpoints */
#define USB_MAX_PACKET0     8			/* max endpoint 0 packet size */
#define USB_DMA             0			/* use DMA */
#define USB_DMA_EP          0x00000000	/* for selected endpoints */
...
#define USB_SOF_EVENT       0
#define USB_ERROR_EVENT     0
#define USB_EP_EVENT        0xF	/* Endpoint Events */
#define USB_CONFIGURE_EVENT 1
#define USB_INTERFACE_EVENT 0
#define USB_FEATURE_EVENT   0
...
#define USB_HID             0	/* Human Interface Device */
#define USB_HID_IF_NUM      0	/* HID Interface Number */
#define USB_MSC             0	/* Mass Storage Class */
#define USB_MSC_IF_NUM      0	/* MSC Interface Number */
#define USB_AUDIO           0	/* Audio Device */
#define USB_ADC_CIF_NUM     0	/* Audio Control Interface Number */
#define USB_ADC_SIF1_NUM    1	/* Audio Streaming Interface Number */
#define USB_ADC_SIF2_NUM    2	/* Audio Streaming Interface Number */
#define USB_CDC  			1	/* Communication Device Class */
#define USB_CDC_CIF_NUM     1	/* Control Interface Number */
#define USB_CDC_DIF_NUM     2	/* Data Interface Number */
#define USB_CDC_BUFSIZE     64	/* CDC Buffer */

/*
 * USB Vendor Support
 */
#define USB_VENDOR          0	/* Enables USB Vendor specific Requests */
